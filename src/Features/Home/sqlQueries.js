...
ORDER BY
    property.created_at DESC LIMIT 10) AS property_inner_subselect 
INNER JOIN
property 
...
ORDER BY
    vehicles.created_at DESC LIMIT 10) AS vehicles_inner_subselect 
INNER JOIN
vehicles 
...
ORDER BY
    hospitality.created_at DESC LIMIT 10) AS hospitality_inner_subselect 
INNER JOIN
hospitality 
...
ORDER BY
    education.created_at DESC LIMIT 10) AS education_inner_subselect 
INNER JOIN
education 
...
WHERE
    doctors.is_active = 1 
ORDER BY
    doctors.created_at DESC LIMIT 10) AS doctors_inner_subselect 
INNER JOIN
doctors 
...
ORDER BY
    hospitals.created_at DESC LIMIT 10) AS hospitals_inner_subselect 
INNER JOIN
hospitals 
