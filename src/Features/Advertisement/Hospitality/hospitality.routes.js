...
hospitalityRouter.post("/", jwtAuth,checkPlanValidity, fileUpload("images"), validationMiddlewarePost, addAdvertisement)
...
hospitalityRouter.post("/images/:id", jwtAuth, fileUpload("images"), imageValidator, addImage)
