...
educationRouter.post("/", jwtAuth, checkPlanValidity,fileUpload("images"), validationMiddlewarePost, addAdvertisement)
...
educationRouter.post("/images/:id", jwtAuth, fileUpload("images"), imageValidator, addImage)
